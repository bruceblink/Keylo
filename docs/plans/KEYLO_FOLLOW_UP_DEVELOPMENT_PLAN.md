...
当前进展：已使用真实 PostgreSQL 覆盖双组织 resource code、check、batch-check、effective-permissions、resource-tree、成员暂停、角色撤销、组织停用和 organization-scoped refresh session；client、identity source 与组织级机器身份仍属于后续未完成项。
