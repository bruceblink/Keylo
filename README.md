...
* 发布说明见 [docs/RELEASE_1_4.md](docs/RELEASE_1_4.md)
...
本地开发和生产环境都应显式提供 RSA 密钥。未配置私钥/公钥时，服务会在初始化阶段失败。
...
```bash
docker pull ghcr.io/bruceblink/keylo:v1.4.0
```
...
docker run --rm -p 2345:2345 \
  ...
  ghcr.io/bruceblink/keylo:v1.4.0
```
